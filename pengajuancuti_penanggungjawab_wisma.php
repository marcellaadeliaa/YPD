<?php
// FILE: pengajuancuti_penanggungjawab_wisma.php
session_start();
...
<title>Pengajuan Cuti Pribadi - Wisma</title>
<style>
    :root { 
...
<main>
    <div class="form-container">
        ...
        <form action="" method="POST">
            ...
            <textarea name="keterangan" id="keterangan" rows="4" placeholder="Tuliskan alasan atau keterangan cuti Anda..." required></textarea>
