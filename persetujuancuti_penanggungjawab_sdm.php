<?php
// FILE: persetujuancuti_penanggungjawab_sdm.php
session_start();
...
// --- DATA DUMMY untuk Divisi SDM ---
$pengajuan_cuti = [
    [
        'id' => 10,
        'kode_karyawan' => 'SDM-002',
        'nama_karyawan' => 'Gilang',
        'divisi' => 'SDM',
        'jenis_cuti' => 'Cuti Tahunan',
        'mulai_cuti' => '2025-10-25',
        'selesai_cuti' => '2025-10-28',
        'keterangan' => 'Keperluan keluarga',
        'status' => 'Menunggu'
    ],
    [
        'id' => 11,
        'kode_karyawan' => 'SDM-003',
        'nama_karyawan' => 'Ivan',
        'divisi' => 'SDM',
        'jenis_cuti' => 'Cuti Sakit',
        'mulai_cuti' => '2025-10-15',
        'selesai_cuti' => '2025-10-15',
...
<html>
<head>
    <title>Persetujuan Cuti Karyawan - SDM</title>
    <style>
        :root { 
...
<main>
    <div class="card">
        <h2>Persetujuan Pengajuan Cuti (Divisi <?= htmlspecialchars(strtoupper($divisi_pj)) ?>)</h2>
