...
$divisi_pj = "keuangan";
$riwayat_cuti_asli = [
    [ 'id' => 20, 'nama_karyawan' => 'Naufal', 'divisi' => 'Keuangan', 'tgl_mulai' => '2025-10-28', 'jenis_cuti' => 'Cuti Tahunan', 'status' => 'Menunggu', 'waktu_persetujuan' => null ],
    [ 'id' => 21, 'nama_karyawan' => 'Olivia', 'divisi' => 'Keuangan', 'tgl_mulai' => '2025-09-12', 'jenis_cuti' => 'Cuti Sakit', 'status' => 'Diterima', 'waktu_persetujuan' => '2025-09-11 15:00:00' ],
];
// Logika Filter
...
<html lang="id">
<head>
    <title>Riwayat Cuti Divisi - Keuangan</title>
    <style>
            ...
            <form action="" method="GET">
                <div style="display: flex; flex-wrap: wrap; gap: 20px; align-items: flex-end;">
                    ...
                    <div class="filter-buttons">
                        ...
                        <a href="riwayatcuti_penanggungjawab_keuangan.php" class="btn-reset">Reset</a>
                    </div>
                </div>
            </form>
        </div>
