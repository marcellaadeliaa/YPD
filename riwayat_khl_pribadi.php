...
// --- DUMMY DATA RIWAYAT KHL PRIBADI ---
$riwayat_khl_pribadi = [
    [
        'id' => 1,
        ...
        'nama_karyawan' => 'Cell',
        'divisi' => 'Training',
        'tanggal_khl' => '2025-09-08',
        'proyek' => 'Proyek A',
        'jam_kerja' => '08:00 - 17:00',
        'tanggal_cuti_khl' => '2025-09-10',
        'jam_cuti_khl' => '09:00 - 16:00',
        'status' => 'Diterima',
    ...
    [
        ...
        'nama_karyawan' => 'Cell',
        'divisi' => 'Training',
        'tanggal_khl' => '2025-09-15',
        'proyek' => 'Proyek B',
        'jam_kerja' => '09:00 - 18:00',
        'tanggal_cuti_khl' => '2025-09-17',
        'jam_cuti_khl' => '10:00 - 17:00',
        'status' => 'Diterima',
        'waktu_persetujuan' => '2025-09-16 14:34:00'
    ],
    [
        'id' => 3,
        'kode_karyawan' => '123456789',
        'nama_karyawan' => 'Cell',
        'divisi' => 'Training',
        'tanggal_khl' => '2025-09-20',
        'proyek' => 'Proyek A',
        'jam_kerja' => '08:00 - 16:00',
        'tanggal_cuti_khl' => '2025-09-22',
        'jam_cuti_khl' => '08:00 - 15:00',
        'status' => 'Ditolak',
    ...
    [
        ...
        'nama_karyawan' => 'Cell',
        'divisi' => 'Training',
        'tanggal_khl' => '2025-10-01',
        'proyek' => 'Proyek C',
        'jam_kerja' => '08:00 - 17:00',
        'tanggal_cuti_khl' => '2025-10-03',
        'jam_cuti_khl' => '09:00 - 16:00',
        'status' => 'Menunggu',
        'waktu_persetujuan' => ''
    ],
...
if (isset($_SESSION['last_khl'])) {
    $last_khl = $_SESSION['last_khl'];
    $riwayat_khl_pribadi[] = [
        'id' => count($riwayat_khl_pribadi) + 1,
        'kode_karyawan' => '123456789',
        'nama_karyawan' => 'Cell',
        'divisi' => 'Training',
        'tanggal_khl' => $last_khl['tanggal_khl'],
        'proyek' => $last_khl['proyek'],
        'jam_kerja' => $last_khl['jam_mulai_kerja'] . ' - ' . $last_khl['jam_akhir_kerja'],
        'tanggal_cuti_khl' => $last_khl['tanggal_cuti'],
        'jam_cuti_khl' => $last_khl['jam_mulai_cuti'] . ' - ' . $last_khl['jam_akhir_cuti'],
        'status' => $last_khl['status'],
        'waktu_persetujuan' => ''
    ];
}

// Filter data berdasarkan input
$filtered_data = $riwayat_khl_pribadi;
...
if (!empty($start_date) && !empty($end_date)) {
    ...
    $filtered_data = array_filter($filtered_data, function($khl) use ($start_timestamp, $end_timestamp) {
        $khl_timestamp = strtotime($khl['tanggal_khl']);
    ...
    $filtered_data = array_filter($filtered_data, function($khl) use ($start_timestamp) {
        return strtotime($khl['tanggal_khl']) >= $start_timestamp;
    });
} elseif (!empty($end_date)) {
    $end_timestamp = strtotime($end_date);
    $filtered_data = array_filter($filtered_data, function($khl) use ($end_timestamp) {
        return strtotime($khl['tanggal_khl']) <= $end_timestamp;
    });
}
...
if (!empty($search_query)) {
    ...
    $filtered_data = array_filter($filtered_data, function($khl) use ($search_lower) {
        return strpos(strtolower($khl['proyek']), $search_lower) !== false ||
               strpos(strtolower($khl['status']), $search_lower) !== false;
    });
}
