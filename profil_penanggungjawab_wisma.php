...
// ID diubah menjadi 7 untuk Cici (Penanggung Jawab Wisma).
$id_karyawan = 7; 

// Menentukan variabel divisi untuk tautan navigasi
$divisi_pj = 'wisma';
...
<title>Profil Penanggung Jawab - Wisma</title>
<style>
...
<header>
    ...
    <nav>
        <ul>
            <li><a href="dashboardpenanggungjawab_<?= $divisi_pj ?>.php">Beranda</a></li>
            <li><a href="#">Cuti ▾</a>
                <ul>
                    <li><a href="persetujuancuti_penanggungjawab_<?= $divisi_pj ?>.php">Persetujuan Cuti Karyawan</a></li>
                    <li><a href="riwayatcuti_penanggungjawab_<?= $divisi_pj ?>.php">Riwayat Cuti Karyawan</a></li>
                    <li><a href="pengajuancuti_penanggungjawab_<?= $divisi_pj ?>.php">Ajukan Cuti Pribadi</a></li>
                    <li><a href="kalender_cuti_penanggungjawab_<?= $divisi_pj ?>.php">Kalender Cuti Divisi</a></li>
                    <li><a href="riwayat_cuti_pribadi_penanggungjawab_<?= $divisi_pj ?>.php">Riwayat Cuti Pribadi</a></li>
                </ul>
            </li>
            <li><a href="#">KHL ▾</a>
                <ul>
                    <li><a href="persetujuankhl_penanggungjawab_<?= $divisi_pj ?>.php">Persetujuan KHL Karyawan</a></li>
                    <li><a href="riwayatkhl_penanggungjawab_<?= $divisi_pj ?>.php">Riwayat KHL Karyawan</a></li>
                    <li><a href="pengajuankhl_penanggungjawab_<?= $divisi_pj ?>.php">Ajukan KHL Pribadi</a></li>
                    <li><a href="kalender_khl_penanggungjawab_<?= $divisi_pj ?>.php">Kalender KHL Divisi</a></li>
                    <li><a href="riwayat_khl_pribadi_penanggungjawab_<?= $divisi_pj ?>.php">Riwayat KHL Pribadi</a></li>
                </ul>
            </li>
            <li><a href="karyawan_divisi_<?= $divisi_pj ?>.php">Karyawan Divisi</a></li>
            <li><a href="#">Profil ▾</a>
                <ul>
                    <li><a href="profil_penanggungjawab_<?= $divisi_pj ?>.php">Profil Saya</a></li>
...
<main>
  <div class="card">
      ...
      <?php else: ?>
        <p style="text-align:center;">Data profil untuk ID #<?= $id_karyawan ?> tidak ditemukan.</p>
      <?php endif; ?>
      <a href="dashboardpenanggungjawab_<?= $divisi_pj ?>.php" class="btn-kembali">Kembali ke Dashboard</a>
  </div>
</main>
