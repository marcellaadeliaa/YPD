...
// Diasumsikan ID penanggung jawab disimpan di session setelah login.
// ID diubah menjadi 5 untuk Budi (Penanggung Jawab Konsultasi).
// Pada implementasi nyata, baris ini seharusnya: $id_karyawan = $_SESSION['id_karyawan'];
$id_karyawan = 6; 
...
<title>Profil Penanggung Jawab</title>
<style>
    /* CSS disalin dari data_pribadi.php untuk tampilan yang konsisten */
