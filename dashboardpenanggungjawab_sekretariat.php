<?php
// FILE: dashboardpenanggungjawab_sekretariat.php
session_start();

// --- Informasi Penanggung Jawab Divisi Sekretariat ---
$nama_pj = "Jasmine";
$jabatan = "Penanggung Jawab Divisi Sekretariat";
$divisi_pj = "Sekretariat";

// Data dummy untuk kartu
$cuti_menunggu = 1; 
$khl_menunggu = 1;
$total_karyawan_divisi = 3;

// Data dummy untuk tabel
$latest_requests = [
    ['jenis' => 'KHL', 'nama_karyawan' => 'Lila', 'created_at' => '2025-10-04'],
    ['jenis' => 'Cuti', 'nama_karyawan' => 'Kevin', 'created_at' => '2025-10-02'],
];
?>
<!DOCTYPE html>
<html lang="id">
<head>
    ...
    <title>Dashboard Penanggung Jawab - Sekretariat</title>
    <style>
...
<main>
    ...
    <div class="dashboard-grid">
        <div class="card">
            ...
            <a href="persetujuancuti_penanggungjawab_sekretariat.php" class="btn">Lihat Rincian</a>
        </div>
        <div class="card">
            <h3>KHL Menunggu Persetujuan</h3>
            <p class="pending-count"><?= $khl_menunggu ?></p>
            <a href="persetujuankhl_penanggungjawab_sekretariat.php" class="btn">Lihat Rincian</a>
        </div>
        <div class="card">
            <h3>Total Karyawan Divisi</h3>
            <p class="pending-count"><?= $total_karyawan_divisi ?></p>
            <a href="karyawan_divisi_sekretariat.php" class="btn">Lihat Data</a>
        </div>
        <div class="card">
            <h3>Kalender Cuti Divisi</h3>
            <div class="calendar-icon">📅</div>
            <p>Akses kalender untuk melihat jadwal cuti karyawan di divisi Anda.</p>
            <a href="kalender_cuti_penanggungjawab_sekretariat.php" class="btn">Lihat Kalender Cuti</a>
        </div>
        <div class="card">
            <h3>Kalender KHL Divisi</h3>
            <div class="calendar-icon">📅</div>
            <p>Akses kalender untuk melihat jadwal KHL karyawan di divisi Anda.</p>
            <a href="kalender_khl_penanggungjawab_sekretariat.php" class="btn">Lihat Kalender KHL</a>
        </div>
    </div>
    <div class="card">
