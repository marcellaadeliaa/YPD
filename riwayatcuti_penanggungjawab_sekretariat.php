...
$riwayat_cuti_asli = [
    [ 'id' => 16, 'nama_karyawan' => 'Kevin', 'divisi' => 'Sekretariat', 'tgl_mulai' => '2025-10-20', 'jenis_cuti' => 'Cuti Alasan Penting', 'status' => 'Menunggu', 'waktu_persetujuan' => null ],
    [ 'id' => 18, 'nama_karyawan' => 'Lila', 'divisi' => 'Sekretariat', 'tgl_mulai' => '2025-09-10', 'jenis_cuti' => 'Cuti Tahunan', 'status' => 'Diterima', 'waktu_persetujuan' => '2025-09-08 11:00:00' ],
];
// Logika Filter
...
<html lang="id">
<head>
    <title>Riwayat Cuti Divisi - Sekretariat</title>
    <style>
...
<main>
    <div class="card">
        <h2>Riwayat Pengajuan Cuti (Divisi <?= ucfirst($divisi_pj) ?>)</h2>
            ...
            <form action="" method="GET">
                <div style="display: flex; flex-wrap: wrap; gap: 20px; align-items: flex-end;">
                    ...
                    <div class="filter-buttons">
                        ...
                        <a href="riwayatcuti_penanggungjawab_sekretariat.php" class="btn-reset">Reset</a>
                    </div>
                </div>
            </form>
        </div>
        <table class="data-table">
            ...
            <tbody>
                <?php if (!empty($riwayat_cuti_filter)): ?>
                    ...
                    <?php endforeach; ?>
                <?php else: ?>
                    <tr><td colspan="7" class="no-data">Tidak ada data riwayat cuti.</td></tr>
                <?php endif; ?>
            </tbody>
        </table>
    </div>
