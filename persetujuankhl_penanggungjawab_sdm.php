<?php
// FILE: persetujuankhl_penanggungjawab_sdm.php
session_start();
$divisi_pj = "sdm";
$pesan_aksi = '';
...
$pengajuan_khl = [
    [ 'id' => 12, 'kode_karyawan' => 'SDM-004', 'nama_karyawan' => 'Hana', 'divisi' => 'SDM', 'proyek' => 'Rekrutmen Karyawan Baru', 'tanggal_kerja' => '2025-10-18', 'jam_mulai_kerja' => '09:00', 'jam_selesai_kerja' => '13:00', 'tanggal_libur' => '2025-10-20' ],
];
?>
<!DOCTYPE html>
<html>
<head>
    <title>Persetujuan KHL Karyawan - SDM</title>
    <style>
...
<main>
    <div class="card">
        <h2>Persetujuan Pengajuan KHL (Divisi <?= htmlspecialchars(strtoupper($divisi_pj)) ?>)</h2>
        <?php if ($pesan_aksi): ?>
                    ...
                    <?php if (!empty($pengajuan_khl)): ?>
                        ...
                        <tr>
                            ...
                            <td class="action-links">
                                <a href="?action=approve&id=<?= $khl['id'] ?>" class="action-approve" title="Setujui" onclick="return confirm('Anda yakin?')">✓</a>
                                <a href="?action=reject&id=<?= $khl['id'] ?>" class="action-reject" title="Tolak" onclick="return confirm('Anda yakin?')">✗</a>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                    <?php else: ?>
