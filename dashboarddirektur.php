            ...
            <li><a href="#">Cuti ▾</a> 
                <ul> 
                    ...
                    <li><a href="riwayat_cuti_direktur.php">Riwayat Semua Cuti</a></li> 
                     <li><a href="riwayat_cuti_direktur.php">Riwayat Cuti Pribadi</a></li> 
...
<main>
    ...
    <div class="dashboard-grid">
        ...
        <div class="card">
            ...
            <div class="calendar-mini" id="mini-calendar-cuti">
                <!-- Mini calendar akan diisi oleh JavaScript -->
            </div>
        ...
        <div class="card">
            ...
            <div class="calendar-icon">📅</div>
            <div class="calendar-mini" id="mini-calendar-khl">
                <!-- Mini calendar akan diisi oleh JavaScript -->
            </div>
...
// Inisialisasi mini calendar saat halaman dimuat
