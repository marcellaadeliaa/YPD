<?php
session_start();
$user_data = [ 'nik' => 'SKR-001', 'nama' => 'Jasmine', 'divisi' => 'Sekretariat' ];
$filtered_data = []; // Riwayat pribadi dikosongkan
?>
<!DOCTYPE html>
<html lang="id">
<head>
    <title>Riwayat Cuti Pribadi - Sekretariat</title>
    <style>
...
<main>
    <div class="card">
        ...
        <a href="pengajuancuti_penanggungjawab_sekretariat.php" class="btn btn-ajukan">+ Ajukan Cuti Baru</a>
