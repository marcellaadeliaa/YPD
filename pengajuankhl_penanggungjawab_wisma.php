<?php
// FILE: pengajuankhl_penanggungjawab_wisma.php
session_start();

// Data Penanggung Jawab Divisi Wisma (Placeholder)
$nama_pj = "Cici";
$kode_pj = "WSM-001";
?>
<!DOCTYPE html>
...
<title>Pengajuan KHL Pribadi - Wisma</title>
<style>
    :root { 
...
<main>
    <div class="form-container">
        ...
        <form action="" method="POST">
            ...
            <input type="text" name="projek" id="projek" placeholder="Contoh: Penanganan Tamu VIP" required>
