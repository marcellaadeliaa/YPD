<?php
// FILE: dashboardpenanggungjawab_wisma.php
session_start();

// --- Informasi Penanggung Jawab Divisi Wisma ---
$nama_pj = "Cici"; // Contoh nama
$jabatan = "Penanggung Jawab Divisi Wisma";
$divisi_pj = "Wisma";

// Data dummy untuk kartu
$cuti_menunggu = 0; 
$khl_menunggu = 2;
$total_karyawan_divisi = 3; // Contoh jumlah karyawan

// Data dummy untuk tabel (dikosongkan atau disesuaikan)
$latest_requests = [
    ['jenis' => 'KHL', 'nama_karyawan' => 'Doni', 'created_at' => '2025-10-02'],
    ['jenis' => 'KHL', 'nama_karyawan' => 'Fahmi', 'created_at' => '2025-09-28'],
];
?>
<!DOCTYPE html>
<html lang="id">
<head>
    ...
    <title>Dashboard Penanggung Jawab - Wisma</title>
    <style>
...
<main>
    ...
    <div class="dashboard-grid">
        <div class="card">
            ...
            <a href="persetujuancuti_penanggungjawab_wisma.php" class="btn">Lihat Rincian</a>
        </div>
        <div class="card">
            <h3>KHL Menunggu Persetujuan</h3>
            <p class="pending-count"><?= $khl_menunggu ?></p>
            <a href="persetujuankhl_penanggungjawab_wisma.php" class="btn">Lihat Rincian</a>
        </div>
        <div class="card">
            <h3>Total Karyawan Divisi</h3>
            <p class="pending-count"><?= $total_karyawan_divisi ?></p>
            <a href="karyawan_divisi_wisma.php" class="btn">Lihat Data</a>
        </div>
        ...
        <div class="card">
            ...
            <a href="kalender_cuti_penanggungjawab_wisma.php" class="btn">Lihat Kalender Cuti</a>
        </div>
        ...
        <div class="card">
            ...
            <a href="kalender_khl_penanggungjawab_wisma.php" class="btn">Lihat Kalender KHL</a>
        </div>
        </div>
    <div class="card">
        ...
        <table class="data-table">
            ...
            <tbody>
                ...
                <?php else: ?>
                    <tr>
                        <td colspan="3" style="text-align: center;">Tidak ada pengajuan terbaru.</td>
                    </tr>
                <?php endif; ?>
            </tbody>
        </table>
