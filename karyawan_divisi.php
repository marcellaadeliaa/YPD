...
$karyawan_divisi = [];
$sql = "SELECT id_karyawan, kode_karyawan, nama_lengkap, email, jabatan, role, no_telp, 
               sisa_cuti_tahunan, sisa_cuti_lustrum, status_aktif 
        FROM data_karyawan 
        WHERE divisi = ? 
            ...
            <table class="data-table" id="employeeTable">
                ...
                <tbody id="tableBody">
                    <?php if (empty($karyawan_divisi)): ?>
                        <tr>
                            <td colspan="8" class="no-results">Belum ada data karyawan di divisi ini</td>
                        </tr>
                    <?php else: ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="cuti-info">
                                    <div class="cuti-item">
                                        <span class="cuti-label">Tahunan:</span>
                                        <span class="cuti-tahunan"><?= htmlspecialchars($data['sisa_cuti_tahunan']); ?> hari</span>
                                    </div>
                                    <div class="cuti-item">
                                        <span class="cuti-label">Lustrum:</span>
                                        <span class="cuti-lustrum"><?= htmlspecialchars($data['sisa_cuti_lustrum']); ?> hari</span>
                                    </div>
                                </div>
                            </td>
                            <td>
