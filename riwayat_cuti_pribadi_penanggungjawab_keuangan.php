<?php
session_start();
$user_data = [ 'nik' => 'KEU-001', 'nama' => 'Mega', 'divisi' => 'Keuangan' ];
$filtered_data = []; // Riwayat pribadi dikosongkan
?>
<!DOCTYPE html>
<html lang="id">
<head>
    <title>Riwayat Cuti Pribadi - Keuangan</title>
    <style>
        ...
        .btn { padding: 10px 20px; border: none; border-radius: 6px; font-size: 14px; font-weight: 600; color: #fff; cursor: pointer; text-decoration: none; display: inline-block; text-align: center; }
...
<main>
    <div class="card">
        ...
        <a href="pengajuancuti_penanggungjawab_keuangan.php" class="btn btn-ajukan">+ Ajukan Cuti Baru</a>
        <table class="data-table">
            <thead>
                <tr><th>No.</th><th>Tanggal Cuti</th><th>Jenis Cuti</th><th>Status</th><th>Persetujuan Admin</th></tr>
            </thead>
            <tbody>
                <tr><td colspan="5" class="no-data">Tidak ada data cuti yang ditemukan.</td></tr>
            </tbody>
        </table>
    </div>
</main>
