...
$riwayat_cuti_asli = [
    ...
    [
        ...
        'status' => 'Diterima',
        'waktu_persetujuan' => '2025-09-18 10:30:00'
    ],
    [
        'id' => 5,
        ...
        'nama_karyawan' => 'Fani',
        'divisi' => 'Training',
        'tgl_mulai' => '2025-09-15',
        'jenis_cuti' => 'Cuti Alasan Penting',
        'status' => 'Ditolak',
        'waktu_persetujuan' => '2025-09-14 11:00:00'
    ],
];
...
<head>
    ...
    <title>Riwayat Cuti Divisi</title>
    <style>
        /* CSS LENGKAP DIAMBIL DARI riwayat_cuti.php UNTUK UI YANG SAMA */
        :root {
...
<main>
    <div class="card">
        <h2>Riwayat Pengajuan Cuti (Divisi <?= htmlspecialchars($divisi_pj) ?>)</h2>
            ...
            <form action="" method="GET">
                <div style="display: flex; flex-wrap: wrap; gap: 20px; align-items: flex-end;">
                    ...
                    <div class="filter-buttons">
                        ...
                        <a href="riwayatcuti_penanggungjawab.php" class="btn-reset">Reset</a>
                    </div>
                </div>
            </form>
        </div>
