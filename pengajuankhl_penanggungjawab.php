<?php
// FILE: pengajuankhl_penanggungjawab.php

// Data Penanggung Jawab (Placeholder)
$nama_pj = "Ria";
$kode_pj = "YPD-003";
?>
<!DOCTYPE html>
...
<style>
    /* CSS diambil dan diadaptasi dari formkhlkaryawan.php */
    :root { 
    ...
    /* Styling Form dari formkhlkaryawan.php */
    main {
        padding: 40px 20px;
        display: flex;
...
<main>
    <div class="form-container">
        ...
        <p>Silakan isi detail pekerjaan Anda di hari libur.</p>
        ...
        <form action="" method="POST">
            ...
            <label for="projek">Nama Proyek/Kegiatan</label>
            <input type="text" name="projek" id="projek" placeholder="Contoh: Pelatihan Internal" required>

            <label for="tanggal_khl">Tanggal KHL</label>
            <input type="date" name="tanggal_khl" id="tanggal_khl" required>

            <label for="jam_mulai_kerja">Jam Mulai Kerja</label>
            <input type="time" name="jam_mulai_kerja" id="jam_mulai_kerja" required>
            
            <label for="jam_akhir_kerja">Jam Selesai Kerja</label>
            <input type="time" name="jam_akhir_kerja" id="jam_akhir_kerja" required>

            <label for="tanggal_cuti_khl">Tanggal Pengganti Cuti KHL</label>
            <input type="date" name="tanggal_cuti_khl" id="tanggal_cuti_khl" required>
