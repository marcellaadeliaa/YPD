...
<head>
    ...
    <title>Formulir Pengajuan KHL Pribadi</title>
    <style>
    ...
    <div class="card">
        ...
        <form action="" method="POST">
            <div class="form-group">
                <label for="tgl_khl">Tanggal Kerja</label>
                <input type="date" id="tgl_khl" name="tgl_khl" class="form-control" required>
            </div>
            <div class="form-group">
                <label for="jenis_khl">Jenis KHL</label>
                <select id="jenis_khl" name="jenis_khl" class="form-control" required>
                    <option value="">-- Pilih Jenis --</option>
                    <option value="Lembur">Lembur</option>
                    <option value="Tugas Luar">Tugas Luar Kota</option>
                </select>
            </div>
            <div class="form-group">
