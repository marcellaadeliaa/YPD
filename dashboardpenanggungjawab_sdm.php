<?php
// FILE: dashboardpenanggungjawab_sdm.php
session_start();

// --- Informasi Penanggung Jawab Divisi SDM ---
$nama_pj = "Dian"; // Contoh nama
$jabatan = "Penanggung Jawab Divisi SDM";
$divisi_pj = "SDM";

// Data dummy untuk kartu
$cuti_menunggu = 2; 
$khl_menunggu = 1;
$total_karyawan_divisi = 4; // Contoh jumlah karyawan

// Data dummy untuk tabel
$latest_requests = [
    ['jenis' => 'Cuti', 'nama_karyawan' => 'Gilang', 'created_at' => '2025-10-03'],
    ['jenis' => 'KHL', 'nama_karyawan' => 'Hana', 'created_at' => '2025-10-02'],
    ['jenis' => 'Cuti', 'nama_karyawan' => 'Ivan', 'created_at' => '2025-10-01'],
];
?>
<!DOCTYPE html>
<html lang="id">
<head>
    ...
    <title>Dashboard Penanggung Jawab - SDM</title>
    <style>
...
<main>
    ...
    <div class="dashboard-grid">
        <div class="card">
            ...
            <a href="persetujuancuti_penanggungjawab_sdm.php" class="btn">Lihat Rincian</a>
        </div>
        <div class="card">
            <h3>KHL Menunggu Persetujuan</h3>
            <p class="pending-count"><?= $khl_menunggu ?></p>
            <a href="persetujuankhl_penanggungjawab_sdm.php" class="btn">Lihat Rincian</a>
        </div>
        <div class="card">
            <h3>Total Karyawan Divisi</h3>
            <p class="pending-count"><?= $total_karyawan_divisi ?></p>
            <a href="karyawan_divisi_sdm.php" class="btn">Lihat Data</a>
        </div>
        <div class="card">
            <h3>Kalender Cuti Divisi</h3>
            <div class="calendar-icon">📅</div>
            <p>Akses kalender untuk melihat jadwal cuti karyawan di divisi Anda.</p>
            <a href="kalender_cuti_penanggungjawab_sdm.php" class="btn">Lihat Kalender Cuti</a>
        </div>
        <div class="card">
            <h3>Kalender KHL Divisi</h3>
            <div class="calendar-icon">📅</div>
            <p>Akses kalender untuk melihat jadwal KHL karyawan di divisi Anda.</p>
            <a href="kalender_khl_penanggungjawab_sdm.php" class="btn">Lihat Kalender KHL</a>
        </div>
    </div>
    <div class="card">
