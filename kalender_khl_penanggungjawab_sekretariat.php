...
$semua_data_pengajuan = [
    [ 'nama_karyawan' => 'Lila', 'divisi' => 'Sekretariat', 'tanggal_pengajuan' => '2025-10-11', 'jenis' => 'KHL', 'status' => 'Menunggu' ],
    [ 'nama_karyawan' => 'Kevin', 'divisi' => 'Sekretariat', 'tanggal_pengajuan' => '2025-09-06', 'jenis' => 'KHL', 'status' => 'Diterima' ],
];
// ... (Logika Kalender) ...
$data_khl_divisi = [];
foreach ($semua_data_pengajuan as $p) { if ($p['jenis']==='KHL' && $p['divisi']===$divisi_pj) { $data_khl_divisi[]=$p; } }
$month = isset($_GET['month']) ? (int)$_GET['month'] : 10; $year = isset($_GET['year']) ? (int)$_GET['year'] : 2025;
...
<html lang="id">
<head>
    <title>Kalender KHL Divisi - Sekretariat</title>
    <style>
