<?php
// FILE: persetujuancuti_penanggungjawab_wisma.php
session_start();
...
if (isset($_GET['action']) && isset($_GET['id'])) {
    $action = $_GET['action'];
    $id = $_GET['id'];
    // Logika untuk memproses aksi approve/reject akan ada di sini
...
// --- DATA DUMMY untuk Divisi Wisma (Dikosongkan) ---
$pengajuan_cuti = []; // Tidak ada data cuti yang menunggu persetujuan

?>
<!DOCTYPE html>
<html>
<head>
    <title>Persetujuan Cuti Karyawan - Wisma</title>
    <style>
        :root { 
