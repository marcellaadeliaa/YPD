<?php
// FILE: riwayatkhl_penanggungjawab_wisma.php
session_start();
...
$riwayat_khl_asli = [
    [
        ...
        'kode_khl' => 'KHL-008',
        'nama_karyawan' => 'Doni',
        'jenis_khl' => 'Acara Khusus',
        'projek' => 'Persiapan Rapat Tahunan',
        'tanggal_kerja' => '2025-08-10',
        'jam_mulai_kerja' => '08:00:00',
        'jam_selesai_kerja' => '15:00:00',
        'tanggal_libur' => '2025-08-18',
        'status' => 'Diterima'
    ],
    [
        'id' => 9,
        'kode_khl' => 'KHL-009',
        'nama_karyawan' => 'Fahmi',
        'jenis_khl' => 'Perbaikan Mendesak',
        'projek' => 'Perbaikan Pipa Air',
        'tanggal_kerja' => '2025-07-20',
        'jam_mulai_kerja' => '19:00:00',
        'jam_selesai_kerja' => '21:00:00',
        'tanggal_libur' => '2025-07-22',
        'status' => 'Ditolak'
    ],
];
...
<head>
    ...
    <title>Riwayat KHL Divisi - Wisma</title>
    <style>
        :root {
        ...
        .status-diterima, .status-ditolak { padding: 5px 10px; border-radius: 15px; font-weight: 600; font-size: 12px; }
            ...
            <form action="" method="GET">
                <div style="display: flex; flex-wrap: wrap; gap: 20px; align-items: flex-end;">
                    ...
                    <div class="filter-buttons">
                        ...
                        <a href="riwayatkhl_penanggungjawab_wisma.php" class="btn-reset">Reset</a>
                    </div>
                </div>
            </form>
        </div>
