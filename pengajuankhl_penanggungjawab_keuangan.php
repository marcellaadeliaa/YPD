...
<html lang="id">
<head>
    <title>Pengajuan KHL Pribadi - Keuangan</title>
    <style>
...
<main>
    <div class="form-container">
        ...
        <form action="" method="POST">
            ...
            <input type="text" id="kode_karyawan" value="<?= htmlspecialchars($kode_pj) ?>" readonly>
            <label for="nama_karyawan">Nama Karyawan</label>
            <input type="text" id="nama_karyawan" value="<?= htmlspecialchars($nama_pj) ?>" readonly>
            <label for="projek">Nama Proyek/Kegiatan</label>
            <input type="text" name="projek" placeholder="Contoh: Laporan Keuangan Bulanan" required>
            ...
            <input type="time" name="jam_mulai_kerja" required>
            <label for="jam_akhir_kerja">Jam Selesai Kerja</label>
            <input type="time" name="jam_akhir_kerja" required>
