...
// [PERUBAHAN]: Mengatur default ke September 2025 agar data Citra terlihat
$month = isset($_GET['month']) ? (int)$_GET['month'] : 9;    // Default ke bulan 9 (September)
$year = isset($_GET['year']) ? (int)$_GET['year'] : 2025;  // Default ke tahun 2025
...
<style>
    ...
    .calendar-day { background: white; min-height: 120px; padding: 8px; position: relative; cursor: pointer; transition: background-color 0.2s; }
...
<main>
    <h1>Kalender KHL Divisi <?= htmlspecialchars($divisi_pj) ?></h1>
