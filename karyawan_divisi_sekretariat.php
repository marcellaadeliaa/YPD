...
$karyawan_divisi = [
    ['id' => 1, 'nama' => 'Jasmine', 'jabatan' => 'Penanggung Jawab', 'sisa_cuti' => 12],
    ['id' => 2, 'nama' => 'Kevin', 'jabatan' => 'Staff Administrasi', 'sisa_cuti' => 7],
    ['id' => 3, 'nama' => 'Lila', 'jabatan' => 'Staff Umum', 'sisa_cuti' => 10],
];
?>
<!DOCTYPE html>
<html lang="id">
<head>
    <title>Data Karyawan Divisi - Sekretariat</title>
    <style>
