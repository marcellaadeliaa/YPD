...
// Untuk contoh ini, kita gunakan ID 4 (Ria - Penanggung Jawab Wisma) dari file .sql Anda.
        ...
        <ul>
            ...
            <li><a href="#">Cuti ▾</a>
                <ul>
                    ...
                    <li><a href="riwayatcuti_penanggungjawab.php">Riwayat Cuti</a></li>
            ...
            <li><a href="#">KHL ▾</a>
                <ul>
                    ...
                    <li><a href="riwayatkhl_penanggungjawab.php">Riwayat KHL</a></li>
...
<main>
  <div class="card">
      ...
      <?php endif; ?>
      <a href="dashboardpenanggungjawab.php" class="btn-kembali">Kembali ke Dashboard</a>
  </div>
</main>
