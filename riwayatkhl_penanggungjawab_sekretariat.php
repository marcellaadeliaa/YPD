...
$riwayat_khl_asli = [
    [ 'id' => 17, 'nama_karyawan' => 'Lila', 'projek' => 'Persiapan RUPS', 'tanggal_kerja' => '2025-10-11', 'jam_mulai_kerja' => '09:00:00', 'jam_selesai_kerja' => '15:00:00', 'tanggal_libur' => '2025-10-13', 'status' => 'Menunggu' ],
    [ 'id' => 19, 'nama_karyawan' => 'Kevin', 'projek' => 'Arsip Dokumen', 'tanggal_kerja' => '2025-09-06', 'jam_mulai_kerja' => '10:00:00', 'jam_selesai_kerja' => '14:00:00', 'tanggal_libur' => '2025-09-08', 'status' => 'Diterima' ],
];
// Logika Filter
$start_date = $_GET['start_date'] ?? ''; $end_date = $_GET['end_date'] ?? ''; $search_query = $_GET['search'] ?? '';
$riwayat_khl_filter = $riwayat_khl_asli;
// ... (logika filter disingkat) ...
?>
<!DOCTYPE html>
<html lang="id">
<head>
    <title>Riwayat KHL Divisi - Sekretariat</title>
    <style>
...
<main>
    <div class="card">
        <h2>Riwayat Pengajuan KHL (Divisi <?= ucfirst($divisi_pj) ?>)</h2>
            ...
            <form action="" method="GET">
                <div style="display: flex; flex-wrap: wrap; gap: 20px; align-items: flex-end;">
                    ...
                    <div class="filter-buttons">
                        ...
                        <a href="riwayatkhl_penanggungjawab_sekretariat.php" class="btn-reset">Reset</a>
                    </div>
                </div>
            </form>
        </div>
                ...
                <tbody>
                    <?php if (!empty($riwayat_khl_filter)): ?>
                        ...
                        <tr>
                            ...
                            <td><span class="status-<?= strtolower($khl['status']) ?>"><?= htmlspecialchars($khl['status']) ?></span></td>
                        </tr>
                        <?php endforeach; ?>
                    <?php else: ?>
                        <tr><td colspan="7" class="no-data">Tidak ada data riwayat KHL yang cocok.</td></tr>
                    <?php endif; ?>
                </tbody>
            </table>
        </div>
