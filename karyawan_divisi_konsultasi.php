<?php
// FILE: karyawan_divisi_konsultasi.php
$divisi_pj = "Konsultasi"; // Diubah dari IT
$karyawan_divisi = [
    // Data karyawan diubah sesuai permintaan
    ['id' => 1, 'nama' => 'Gita', 'jabatan' => 'Konsultan Senior', 'sisa_cuti' => 7],
    ['id' => 2, 'nama' => 'Indra', 'jabatan' => 'Konsultan', 'sisa_cuti' => 9],
    ['id' => 3, 'nama' => 'Hadi', 'jabatan' => 'Asisten Konsultan', 'sisa_cuti' => 12],
];
?>
<!DOCTYPE html>
<html lang="id">
