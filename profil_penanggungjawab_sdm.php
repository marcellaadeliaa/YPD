...
// ID untuk Dian (Penanggung Jawab SDM)
$id_karyawan = 8; 
$divisi_pj = 'sdm';
$data = null;
...
<head>
    ...
    <title>Profil Penanggung Jawab - SDM</title>
    <style>
...
<main>
  <div class="card">
      ...
      <?php endif; ?>
      <a href="dashboardpenanggungjawab_sdm.php" class="btn-kembali">Kembali ke Dashboard</a>
  </div>
</main>
</body>
</html>