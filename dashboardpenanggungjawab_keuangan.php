<?php
// FILE: dashboardpenanggungjawab_keuangan.php
session_start();

// --- Informasi Penanggung Jawab Divisi Keuangan ---
$nama_pj = "Mega";
$jabatan = "Penanggung Jawab Divisi Keuangan";
$divisi_pj = "Keuangan";
...
$latest_requests = [
    ['jenis' => 'Cuti', 'nama_karyawan' => 'Naufal', 'created_at' => '2025-10-05'],
];
?>
<!DOCTYPE html>
<html lang="id">
<head>
    ...
    <title>Dashboard Penanggung Jawab - Keuangan</title>
    <style>
...
<main>
    ...
    <div class="dashboard-grid">
        <div class="card">
            ...
            <a href="persetujuancuti_penanggungjawab_keuangan.php" class="btn">Lihat Rincian</a>
        </div>
        <div class="card">
            <h3>KHL Menunggu Persetujuan</h3>
            <p class="pending-count"><?= $khl_menunggu ?></p>
            <a href="persetujuankhl_penanggungjawab_keuangan.php" class="btn">Lihat Rincian</a>
        </div>
        <div class="card">
            <h3>Total Karyawan Divisi</h3>
            <p class="pending-count"><?= $total_karyawan_divisi ?></p>
            <a href="karyawan_divisi_keuangan.php" class="btn">Lihat Data</a>
        </div>
        <div class="card">
            <h3>Kalender Cuti Divisi</h3>
            <div class="calendar-icon">📅</div>
            <p>Akses kalender untuk melihat jadwal cuti karyawan di divisi Anda.</p>
            <a href="kalender_cuti_penanggungjawab_keuangan.php" class="btn">Lihat Kalender Cuti</a>
        </div>
        <div class="card">
            <h3>Kalender KHL Divisi</h3>
            <div class="calendar-icon">📅</div>
            <p>Akses kalender untuk melihat jadwal KHL karyawan di divisi Anda.</p>
            <a href="kalender_khl_penanggungjawab_keuangan.php" class="btn">Lihat Kalender KHL</a>
        </div>
    </div>
    <div class="card">
