...
// ID untuk Mega (Penanggung Jawab Keuangan) - sesuaikan dengan DB Anda
$id_karyawan = 10; 
$divisi_pj = 'keuangan';
$data = null;
...
<html lang="id">
<head>
    <title>Profil Penanggung Jawab - Keuangan</title>
    <style>
...
<main>
  <div class="card">
      ...
      <?php endif; ?>
      <a href="dashboardpenanggungjawab_keuangan.php" class="btn-kembali">Kembali ke Dashboard</a>
  </div>
</main>
</body>
</html>