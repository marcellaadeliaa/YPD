...
$divisi_pj = "keuangan";
$riwayat_khl_asli = [
    [ 'id' => 22, 'nama_karyawan' => 'Putra', 'projek' => 'Audit Akhir Bulan', 'tanggal_kerja' => '2025-09-27', 'jam_mulai_kerja' => '09:00:00', 'jam_selesai_kerja' => '17:00:00', 'tanggal_libur' => '2025-09-29', 'status' => 'Diterima' ],
];
// Logika Filter
...
<html lang="id">
<head>
    <title>Riwayat KHL Divisi - Keuangan</title>
    <style>
            ...
            <form action="" method="GET">
                <div style="display: flex; flex-wrap: wrap; gap: 20px; align-items: flex-end;">
                    ...
                    <div class="filter-buttons">
                        ...
                        <a href="riwayatkhl_penanggungjawab_keuangan.php" class="btn-reset">Reset</a>
                    </div>
                </div>
            </form>
        </div>
            ...
            <table class="data-table">
                ...
                <tbody>
                    <?php if (!empty($riwayat_khl_filter)): ?>
                        ...
                        <?php endforeach; ?>
                    <?php else: ?>
                        <tr><td colspan="7" class="no-data">Tidak ada data riwayat KHL.</td></tr>
                    <?php endif; ?>
                </tbody>
            </table>
        </div>
