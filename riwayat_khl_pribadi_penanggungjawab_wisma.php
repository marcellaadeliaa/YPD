...
$user_data = [
    'nik' => 'WSM-001',      // Contoh NIK untuk Wisma
    'nama' => 'Cici',       // Contoh Nama untuk Wisma
    'divisi' => 'Wisma'
];

// Data riwayat sengaja dikosongkan
$filtered_data = [];
...
<title>Riwayat KHL Pribadi - Penanggung Jawab Wisma</title>
<style>
...
<main>
    <div class="card">
        ...
        <a href="pengajuankhl_penanggungjawab_wisma.php" class="btn btn-ajukan">+ Ajukan KHL Baru</a>
        ...
        <table class="data-table">
            ...
            <tbody>
                ...
                <?php else: ?>
                    <tr>
                        <td colspan="7" class="no-data">Tidak ada data KHL yang ditemukan.</td>
                    </tr>
                <?php endif; ?>
            </tbody>
        </table>
