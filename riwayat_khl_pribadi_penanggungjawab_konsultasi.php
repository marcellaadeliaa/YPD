...
// Data riwayat KHL sengaja dikosongkan sesuai pola permintaan sebelumnya
$filtered_data = [];
...
<title>Riwayat KHL Pribadi - Penanggung Jawab Konsultasi</title>
<style>
    ...
    @media (max-width: 768px) { .data-table { font-size: 12px; } .data-table th, .data-table td { padding: 8px 10px; } }
</style>
</head>
<body>
...
<main>
    <div class="card">
        ...
        <a href="pengajuankhl_penanggungjawab_konsultasi.php" class="btn btn-ajukan">+ Ajukan KHL Baru</a>
        ...
        <table class="data-table">
            ...
            <tbody>
                <?php if (!empty($filtered_data)): ?>
                    <?php // Loop akan dilewati karena data kosong ?>
                <?php else: ?>
                    <tr>
