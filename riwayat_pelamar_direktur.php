...
<head>
    ...
    <title>Riwayat Pelamar - Direktur</title>
    <style>
    ...
    <div class="card">
        ...
        <form method="GET" action="" class="action-bar">
            ...
            <?php if(isset($_GET['search']) && !empty($_GET['search'])): ?>
                <a href="riwayat_pelamar_direktur.php" style="padding: 10px 15px; background: #6c757d; color: white; text-decoration: none; border-radius: 8px; font-size: 16px;">Reset</a>
            <?php endif; ?>
        </form>
                    ...
                    <?php if ($riwayat_pelamar_result->num_rows > 0): ?>
                        <?php while($row = $riwayat_pelamar_result->fetch_assoc()): ?>
                            <tr>
                                ...
                                <td><a href="detail_pelamar_direktur.php?id=<?= $row['id'] ?>" class="btn-aksi btn-lihat">Lihat</a></td>
                            </tr>
                        <?php endwhile; ?>
                    <?php else: ?>
