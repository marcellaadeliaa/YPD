...
<head>
    ...
    <style>
        /* Background dengan gambar gedung */
        body {
            min-height: 100vh;
        ...
        /* Menyembunyikan kolom kiri karena background sudah pakai gambar gedung */
        .left-col {
            display: none;
        }
        ...
        .card {
            width: 100%;
            background: linear-gradient(180deg, rgba(42,22,92,0.95) 0%, rgba(50,30,110,0.95) 100%);
            border-radius: 28px;
            padding: 40px 35px;
        ...
        /* Styling khusus untuk dropdown role */
        select.form-input {
            appearance: none;
        ...
        select.form-input::-webkit-listbox,
        select.form-input::-webkit-select-list-box {
            background: #2a165c;
            color: white;
        }

        select.form-input::-webkit-option {
            background: #2a165c;
            color: white;
            padding: 10px;
        }
                        ...
                        <form class="login-form" action="auth.php" method="POST">
                            <?php if (isset($_GET['error'])): ?>
                                <div class="error-message">
                                    <?php 
                                    $errors = [
                                        'invalid' => 'Kode karyawan/nama atau password salah!',
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            roleSelect.addEventListener('change', function() {
                const roleData = {
                    'direktur': { input: 'YPD001', password: 'hashed_password_direktur' },
                    'admin': { input: 'YPD002', password: 'hashed_password_admin' },
                    'karyawan': { input: 'YPD101', password: 'hashed_password_karyawan' },
                    'penanggung jawab': { input: 'YPD003', password: 'hashed_password_ria' }
                };
                
                if (roleData[this.value]) {
                    loginInput.value = roleData[this.value].input;
                    passwordInput.value = roleData[this.value].password;
                } else {
                    loginInput.value = '';
                    passwordInput.value = '';
                }
